'''
DO NOT USE THIS CODE. IT IS ONLY FOR REFERENCE.
'''
...
# Load and split your PDF
loader = PyPDFLoader("assets/MCS_Bare_Act_and_Rules.pdf")
pages = loader.load()
text_splitter = RecursiveCharacterTextSplitter(chunk_size=1000, chunk_overlap=150)
documents = text_splitter.split_documents(pages)

# Build embeddings and the vector store
embeddings = HuggingFaceEmbeddings(model_name="sentence-transformers/all-MiniLM-L6-v2")
vectordb = Chroma.from_documents(documents, embedding=embeddings)

# System prompt template for safe, concise, and context-bound answers
TEMPLATE = """
